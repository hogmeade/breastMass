...
def train(args, model, optimizer, loss_fn, train_dataset, val_dataset, test_dataset):
    ...
    for epoch in range(int(args.epochs)):
        ...
        if accuracy > best_acc1 and accuracy >= 0.65:
            best_acc1 = accuracy
            ...
            send_email("Save 2_224 Max validation accuracy: {} @ epoch {} GPU".format(best_acc1,epochState1))
        if epoch == 2998:
    ...
    send_email("{}\nMax validation accuracy: {} @ epoch {} GPU - 2_224 DONE".format(fbase,best_acc1,epochState1))
...
if __name__ == "__main__":
    ...
    args = parser.parse_args()
    execute_exp(args)
# nohup python3 breast.py -probsThresthold 0.96 -batchNumber 1 -batch_size 16 -epochs 4000 -data_path './breast' > 2_224.log &
